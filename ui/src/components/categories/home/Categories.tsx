...
const comingSoonClass = (isComingSoon: boolean) => {
	return (
		isComingSoon &&
		"after:content-['Coming_Soon'] after:w-fit after:font-secondary-sans after:font-normal after:p-2 after:rounded-full after:border after:border-rust-100 after:text-rust-100 after:bg-rust-50/20 after:text-[12px] after:absolute after:top-0 after:right-0 after:m-3"
	);
};
