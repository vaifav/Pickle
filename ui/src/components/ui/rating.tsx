    ...
    for (let i = 1; i <= maxRating; i++) {
      ...
      stars.push(
        ...
        >
          ...
          <Star data-slot="rating-star-empty" className={cn(starVariants({ size }), "fill-secondary-text/30 stroke-none")} />
          ...
          >
            <Star data-slot="rating-star-filled" className={cn(
                                  starVariants({ size }),
                                  "fill-rust-200 stroke-none "
                                )} />
          </div>
        </div>
      )
