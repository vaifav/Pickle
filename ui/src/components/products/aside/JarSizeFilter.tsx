...
import useJarSizeFilter from "@/hooks/useJarSizeFilter";
import { JAR_SIZES } from "@/utils/constants";

const SIZES = Object.values(JAR_SIZES);
const JarSizeFilter = () => {
	const { filterByJarSize, activeSizes } = useJarSizeFilter();
	return (
		<div className="pt-5">
